...
describe UserImportFile do
  ...
  describe "when its mode is 'create'" do
    before(:each) do
      ...
      @file.attachment.attach(io: File.new("#{Rails.root}/../fixtures/files/user_import_file_sample.tsv"), filename: 'attachment.txt')
      @file.save
    end
  ...
  describe "when its mode is 'update'" do
    ...
    it "should update users" do
      ...
      file.attachment.attach(io: File.new("#{Rails.root}/../fixtures/files/user_update_file.tsv"), filename: 'attachment.txt')
      old_message_count = Message.count
      result = file.modify
    ...
    it "should not overwrite with null value" do
      ...
      file.attachment.attach(io: File.new("#{Rails.root}/../fixtures/files/user_update_file2.tsv"), filename: 'attachment.txt')
      result = file.modify
      result.should have_key(:user_updated)
    ...
    it "should update user_number" do
      ...
      file.attachment.attach(io: File.new("#{Rails.root}/../fixtures/files/user_update_file3.tsv"), filename: 'attachment.txt')
      result = file.modify
      result.should have_key(:user_updated)
      user001 = User.find_by(username: 'user001')
    ...
    it "should update user's lock status" do
      ...
      file.attachment.attach(io: File.new("#{Rails.root}/../fixtures/files/user_update_file4.tsv"), filename: 'attachment.txt')
      result = file.modify
      result.should have_key(:user_updated)
      user001 = User.find_by(username: 'user001')
  ...
  describe "when its mode is 'destroy'" do
    ...
    it "should remove users" do
      ...
      file.attachment.attach(io: File.new("#{Rails.root}/../fixtures/files/user_delete_file.tsv"), filename: 'attachment.txt')
      old_message_count = Message.count
      file.remove
