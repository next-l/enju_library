    ...
    describe "When logged in as Administrator" do
      ...
      describe "When basket_id is specified" do
        it "assigns all accepts as @accepts" do
          ...
          assigns(:accepts).should eq Basket.find(10).accepts.order('accepts.created_at DESC').page(1)
          response.should be_success
        end
      end
    end
    ...
    describe "When logged in as Librarian" do
      ...
      describe "When basket_id is specified" do
        it "assigns all accepts as @accepts" do
          ...
          assigns(:accepts).should eq Basket.find(9).accepts.order('accepts.created_at DESC').page(1)
          response.should be_success
        end
      end
    end
