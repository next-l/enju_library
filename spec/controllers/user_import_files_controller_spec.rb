  ...
  describe 'POST create' do
    describe 'When logged in as Librarian' do
      ...
      it 'should create agent_import_file' do
        post :create, params: { user_import_file: {
          attachment: fixture_file_upload('/../../examples/user_import_file_sample.tsv', 'text/csv'),
    ...
    describe 'When logged in as User' do
      ...
      it 'should be forbidden' do
        post :create, params: { user_import_file: { attachment: fixture_file_upload('/../../examples/user_import_file_sample.tsv', 'text/csv') } }
        assigns(:user_import_file).should be_nil
        expect(response).to be_forbidden
      end
    end
