...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency "enju_ndl", "~> 0.1.0.pre32"
  s.add_development_dependency "enju_manifestation_viewer", "~> 0.1.0.pre13"
  s.add_development_dependency "enju_biblio", "~> 0.1.0.pre56"
  s.add_development_dependency "enju_event", "~> 0.1.17.pre19"
