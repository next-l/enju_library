...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency "enju_ndl", "~> 0.1.0.pre23"
  s.add_development_dependency "enju_manifestation_viewer", "~> 0.1.0.pre9"
  s.add_development_dependency "enju_biblio", "~> 0.1.0.pre40"
  s.add_development_dependency "enju_event", "~> 0.1.17.pre12"
  s.add_development_dependency "enju_circulation", "~> 0.1.0.pre25"
